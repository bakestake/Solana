...
namespace Fusion.Addons.Hathora
{
	public static class HathoraRegionUtility
	{
        ...
        public static (bool bestRegionFound, Region bestRegion, double bestRegionPing) FindBestRegion(HathoraCloudSDK hathoraCloudSDK, Region fallbackRegion, bool enableLogs = false)
        {
            // // 1. Get all Hathora endpoints.
            // GetPingServiceEndpointsDeprecatedResponse pingEndpointsResponse = await hathoraCloudSDK.DiscoveryV1.GetPingServiceEndpointsDeprecatedAsync();
