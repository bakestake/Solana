...
{
    /// <summary>
    /// Represents a floating-point range with timed value shifts, allowing for automatic adjustments over time.
    /// </summary>
    [Serializable]
    public class TimedFloatRange : FloatRange
    {
        [SerializeField] protected FreezeableLoopTimer valueShiftTimer;
        [SerializeField] protected float valueShift;
        ...
        /// </summary>
        public float ValueShift => valueShift;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TimedFloatRange"/> class with default values.
        /// </summary>
        public TimedFloatRange() : base() { }

        /// <summary>
        /// Initializes a new instance of the <see cref="TimedFloatRange"/> class with specified parameters.
        /// </summary>
        ...
        public TimedFloatRange(float maxValue, float currentValue, float valueShift, float changeTime, bool isPaused = false, float timeScale = 1) : base(maxValue, currentValue)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TimedFloatRange"/> class by copying values from another instance.
        /// </summary>
        /// <param name="other">The instance to copy values from.</param>
        public TimedFloatRange(TimedFloatRange other) : this(other.MaxValue, other.CurrentValue, other.valueShift, other.ChangeTime, other.IsValueShiftPaused, other.TimeScale) { }
