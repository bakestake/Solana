...
{
    /// <summary>
    /// A temporary floating-point modifier that adjusts its value over time using an <see cref="AnimationCurve"/>.
    /// </summary>
    public class TemporaryFloatModifierWithCurve : TemporaryFloatModifier
    {
        /// <summary>
        ...
        /// </summary>
        public override float CurrentValue => baseValue * ValueCurve.Evaluate(Percentage);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TemporaryFloatModifierWithCurve"/> class.
        /// </summary>
        ...
        public TemporaryFloatModifierWithCurve(ModifierCalculationType type, float value, float durationInSeconds, object source, AnimationCurve curve, string id = null, ModifierStrategy<float> calculationStrategy = null) : base(type, value, durationInSeconds, source, id, calculationStrategy)
        {
            valueCurve = curve;
        }

        public TemporaryFloatModifierWithCurve(TemporaryFloatModifierWithCurve other) : this(other.type, other.baseValue, other.durationInSeconds, other.source, new AnimationCurve(other.valueCurve.keys), other.id, other.calculationStrategy) 
        {
        }

        public TemporaryFloatModifierWithCurve() : base()
        {
