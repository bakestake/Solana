...
{
    /// <summary>
    /// Extends <see cref="DynamicIntRange"/> to include timed value shifts, allowing dynamic updates to the current value based on a timer.
    /// </summary>
    [Serializable]
    public class DynamicTimedIntRange : DynamicIntRange
    {
        [SerializeField] private DynamicInt valueShift;
        ...
        /// </summary>
        public DynamicInt ValueShift => valueShift;
        ...
        public DynamicTimedIntRange() : base() { }
        ...
        public DynamicTimedIntRange(int baseValue, int currentValue, int changeBaseValue, float changeTime, bool isPaused = false, float timeScale = 1) : base(baseValue, currentValue)
        {
            IsValueShiftPaused = isPaused;
            valueShift = new DynamicIntRange(changeBaseValue);
        ...
        /// <param name="changeTime">The time interval at which the value should change.</param>
        /// <param name="isPaused">Initial state of the value shift (paused or not).</param>
        public DynamicTimedIntRange(int baseValue, int changeBaseValue, int changeTime, bool isPaused = false, float timeScale = 1) : this(baseValue, baseValue, changeBaseValue, changeTime, isPaused, timeScale)
        {
        ...
        public DynamicTimedIntRange(DynamicTimedIntRange other) : this(other.BaseValue, other.CurrentValue, other.ValueShift.BaseValue, other.ValueShiftTimer.TimerDuration, other.IsValueShiftPaused, other.ValueShiftTimer.TimeScale)
        {
        ...
        /// <summary>
        /// Returns a string representation of the current state of the DynamicTimedIntRange.
        /// Includes details such as current value, base value, value shift, time scale, change time, and pause/frozen states.
        /// </summary>
        /// <returns>A string that represents the current state of the DynamicTimedIntRange.</returns>
