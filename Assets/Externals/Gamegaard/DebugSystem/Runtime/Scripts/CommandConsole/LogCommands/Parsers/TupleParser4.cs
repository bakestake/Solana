...
{
    public class TupleParser4<T1, T2, T3, T4> : ITypeParser<(T1, T2, T3, T4)>
    {
        public (T1, T2, T3, T4) Parse(string value)
        {
            ...
            T4 item4 = (T4)Convert.ChangeType(parts[3].Trim(), typeof(T4), CultureInfo.InvariantCulture);
