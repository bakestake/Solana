...
{
    [Serializable]
    public class ArrayWarper<T> : ValueWrapper<T[]>, ICollection, IEnumerable, IList, IStructuralComparable, IStructuralEquatable, ICloneable
    {
        ...
        public ArrayWarper(T[] value) : base(value)
        {
        }
