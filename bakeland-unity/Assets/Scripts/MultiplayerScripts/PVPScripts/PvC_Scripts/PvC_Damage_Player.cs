...
public class PvC_Damage_Player : MonoBehaviour
{
    //Has Interacted varibales
    private bool GotHit;
    private float ImmortalDurationAfterHit = 2f;
    public bool IsImmortal => _timer == false;
    ...
    public bool canUltimate { get; set; } = false;
    ...
    public void Start()
    {
        ...
        StartCoroutine(ImmortalTimerCooldown(ImmortalDurationAfterHit));
    ...
    private IEnumerator ImmortalTimerCooldown(float duration)
    {
        _timer = true;
